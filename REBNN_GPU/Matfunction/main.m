...
for i = 1: iteration 
   ...
   % rezonator code (input creation and its recursive dft) 
    sin_fn=3.8*sin(input_ph);
    [rezo_ph,Fn]=rezonator(sin_fn);
    
   % Neural netwrok and related codes (for multi output system need to
   % rewrite it with different input-output. )
