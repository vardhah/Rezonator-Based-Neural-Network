###########################################################################
## Makefile generated for Simulink model 'MIMO'. 
## 
## Makefile     : MIMO.mk
## Generated on : Wed Sep 18 11:21:49 2019
## MATLAB Coder version: 4.2 (R2019a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\MIMO.exe
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:\Users\vardhah\Desktop\final_work_consolidation\nonlinearSystem
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = MIMO_comp.rsp
CMD_FILE                  = MIMO.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\MIMO.exe
...
DEFINES_STANDARD = -DMODEL=MIMO -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\MIMO_grt_rtw\MIMO.c $(START_DIR)\MIMO_grt_rtw\MIMO_data.c $(START_DIR)\MIMO_grt_rtw\rtGetInf.c $(START_DIR)\MIMO_grt_rtw\rtGetNaN.c $(START_DIR)\MIMO_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj MIMO.obj MIMO_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\MIMO_grt_rtw}.c.obj :
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\MIMO_grt_rtw}.cpp.obj :
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
